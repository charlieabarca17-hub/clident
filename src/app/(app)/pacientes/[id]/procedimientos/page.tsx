...
import { FormularioProcedimiento } from "./formulario-procedimiento";
        ...
        {puedeEscribir ? (
          <section className="rounded-2xl border bg-card p-5 shadow-sm">
            ...
            {itemsRealizables.length === 0 ? (
              ...
              <FormularioProcedimiento pacienteId={paciente.id} filasDientes={FILAS_DIENTES} itemsRealizables={itemsRealizables} />
            )}
          </section>
        ) : null}
